...
public class BoardService {
	...
	public List<BoardEntity> search(String type, String keyword) {
		...
		case "title":
			...
			break;
		case "writer":
			// select * from board_entity where writer like %keyword% --> ex) '123' 검색 -> 1234, 123123, 123333,11123 ... 출력
			// select * from board_entity where writer = keyword --> ex) '123' 검색 -> 123 만 출력 (정확히 일치)
